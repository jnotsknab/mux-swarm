...
public static class SingleAgentOrchestrator
{
    ...
    private static void HandleCost(string resolvedModelId)
    {
        ...
        bool isSubscription = string.Equals(
            ...
            CliProxyManager.ClientKeyEnvVar,
        ...
        InteractiveSession? interactiveHandle = null)
    {
        ...
        foreach (var nativeTool in NativeToolRegistry.BuildPool(App.Config))
        ...
        int projectedToolCount =
            ...
            + ((App.GigaMode && teamScope is null) ? GigaMode.ToolCount : 0); // giga tools
        ...
        var listSkillsTool = AIFunctionFactory.Create(
            ...
            name: "list_skills",
            description: SkillUsageGuidance.ListDescription + "Returns available skill names and descriptions."
        );

        var readSkillTool = AIFunctionFactory.Create(
            method: (
                [System.ComponentModel.Description(SkillUsageGuidance.SkillNameDescription)]
                string skillName
            ) =>
            {
            ...
            name: "read_skill",
            description: SkillUsageGuidance.ReadDescription
        );
        ...
        if (!MuxConsole.StdioMode && App.ServePort <= 0)
        {
            ...
            ReflectionGatherer.HistoryProvider =
                () => conversationHistory.ToList();
            ReflectionGatherer.Start(chatClientFactory, cancellationToken);
        }
        ...
        do
        {
            ...
            ReflectionInjector.ResetTurn();
            try
            {
                var durableRefl = await ReflectionInjector.BuildDurableDeltaAsync(
