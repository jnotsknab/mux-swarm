...
internal sealed class LineEditor
{
    ...
    public string AtFilter
    {
        get
        {
            ...
            // token is a bare "@" and the cursor is positioned on it, _cursor - (start + 1)
            // is negative - clamp to 0 so
    ...
    {
        // Ctrl-C / Ctrl-D / Esc handling first. The input editor is deliberately modeless:
        // Esc cancels the prompt and printable characters always insert literally.
        bool ctrl = (key.Modifiers & ConsoleModifiers.Control) != 0;
